...
function dashboard(from: string, to: string): Dashboard {
  ...
  const daily = Array.from({ length: n }, (_, i) => { const d = new Date(f); d.setUTCDate(d.getUTCDate() + i); return { day: dayKey(d), new_players: ri(2, 25), active: ri(20, 90), scans: ri(30, 180), cats: ri(5, 60), battles: ri(10, 120), chests: ri(5, 50), gems_spent: ri(500, 6000), gems_issued: ri(800, 7000), gems_exact: true, revenue_pln: ri(0, 220) } })
  ...
  return {
    ...
    geo: {
      countries: [
        { code: 'PL', registered: 84, active: 51, active_1d: 20, active_7d: 51, active_30d: 71, active_all: 84 }, { code: 'UA', registered: 26, active: 14, active_1d: 6, active_7d: 14, active_30d: 20, active_all: 26 },
        { code: 'DE', registered: 11, active: 6, active_1d: 2, active_7d: 6, active_30d: 8, active_all: 11 }, { code: 'FR', registered: 7, active: 3, active_1d: 1, active_7d: 3, active_30d: 4, active_all: 7 },
        { code: 'US', registered: 5, active: 2, active_1d: 1, active_7d: 2, active_30d: 3, active_all: 5 }, { code: 'GB', registered: 3, active: 1, active_1d: 0, active_7d: 1, active_30d: 1, active_all: 3 },
        { code: 'ES', registered: 2, active: 1, active_1d: 0, active_7d: 1, active_30d: 1, active_all: 2 }, { code: 'BR', registered: 1, active: 0, active_1d: 0, active_7d: 0, active_30d: 0, active_all: 1 },
      ],
      cities: [
        { city: 'Warsaw', code: 'PL', registered: 52, active: 33, active_1d: 13, active_7d: 33, active_30d: 46, active_all: 52 }, { city: 'Kraków', code: 'PL', registered: 18, active: 11, active_1d: 4, active_7d: 11, active_30d: 15, active_all: 18 },
        { city: 'Gdańsk', code: 'PL', registered: 14, active: 7, active_1d: 3, active_7d: 7, active_30d: 10, active_all: 14 }, { city: 'Kyiv', code: 'UA', registered: 16, active: 9, active_1d: 4, active_7d: 9, active_30d: 13, active_all: 16 },
        { city: 'Lviv', code: 'UA', registered: 10, active: 5, active_1d: 2, active_7d: 5, active_30d: 7, active_all: 10 }, { city: 'Berlin', code: 'DE', registered: 8, active: 5, active_1d: 2, active_7d: 5, active_30d: 7, active_all: 8 },
        { city: 'Paris', code: 'FR', registered: 7, active: 3, active_1d: 1, active_7d: 3, active_30d: 4, active_all: 7 }, { city: 'New York', code: 'US', registered: 5, active: 2, active_1d: 1, active_7d: 2, active_30d: 3, active_all: 5 },
      ],
      unknown: { registered: 4, active: 1, active_1d: 0, active_7d: 1, active_30d: 2, active_all: 4 },
      by_ip: 121,
...
export async function mockCall(action: string, params: Record<string, unknown>): Promise<unknown> {
  ...
  switch (action) {
    ...
    case 'versions_list': return { versions: [ { build: 78, version: '0.9.26', notes: ['Обычные рамки переработаны по отзывам: новые цвета и украшения в углу экрана', 'Украшения рамок больше не прячутся под чёлкой', '10 невыразительных рамок сняты — владельцам начислены самоцветы'], released_at: '2026-09-02T15:00:00Z' }, { build: 77, version: '0.9.25', notes: ['Помощь приютам: теперь их может быть несколько — у каждого своё сердце, логотип и ссылка', 'В «О игре» показывается правильная версия сборки'], released_at: '2026-09-02T11:00:00Z' }, { build: 76, version: '0.9.24', notes: ['81 иконка рамок перерисована', 'У «Бирки имени» появилась своя иконка'], released_at: '2026-08-31T12:00:00Z' } ], current: { build: 78, version: '0.9.26', notes: ['Обычные рамки переработаны по отзывам'], released_at: '2026-09-02T15:00:00Z' } }
